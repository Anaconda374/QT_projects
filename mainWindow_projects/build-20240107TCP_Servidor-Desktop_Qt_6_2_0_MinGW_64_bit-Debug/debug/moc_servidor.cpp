...
#include <memory>
#include "../../20240107TCP_Servidor/servidor.h"
...
QT_MOC_LITERAL(9, 8), // "cambiado"
QT_MOC_LITERAL(18, 0), // ""
QT_MOC_LITERAL(19, 11), // "desconectar"
QT_MOC_LITERAL(31, 10) // "listo_Leer"

    },
    "Servidor\0cambiado\0\0desconectar\0"
    "listo_Leer"
};
...
void Servidor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Servidor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Servidor::cambiado)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Servidor, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
