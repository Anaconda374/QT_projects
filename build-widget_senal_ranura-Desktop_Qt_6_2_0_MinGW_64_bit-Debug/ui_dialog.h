...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        layoutWidget->setGeometry(QRect(71, 121, 304, 28));
        ...
        btnSaltar = new QPushButton(layoutWidget);
        ...
        QObject::connect(btnSaltar, &QPushButton::clicked, Dialog, qOverload<>(&QDialog::reject));
